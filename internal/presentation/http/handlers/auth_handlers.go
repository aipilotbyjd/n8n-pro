...
type AuthServiceInterface interface {
	...
	InitiatePasswordReset(ctx context.Context, email, ipAddress string) error
	GetUser(ctx context.Context, userID string) (*auth.UserResponse, error)
	UpdateUser(ctx context.Context, userID string, updateData map[string]interface{}) (*auth.UserResponse, error)
...
func (h *AuthHandler) ForgotPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Don't reveal if email exists or not - still return success to prevent enumeration
	}
